/* nvd3 version 1.9.3 (https://github.com/novus/nvd3) 2017-07-17 */
(function(){
...
nv.models.lineChart = function () {
    ...
    function chart(selection) {
        ...
        selection.each(function (data) {
            ...
            focusEnter.append('g').attr('class', 'nv-y nv-axis').attr('transform', 'translate(0,' + 20 + ')');
            ...
            if (!showLegend) {
                ...
                if (legendPosition === 'bottom') {
                    ...
                    availableHeight = nv.utils.availableHeight(height, container, margin);
                    g.select('.nv-legendWrap')
                        .attr('transform', 'translate(0,' + (availableHeight + 20 + xAxis.height()) + ')');
            ...
            if (!focusEnable && focus.brush.extent() === null) {
                ...
                g.select('.nv-focusWrap')
                    ...
                    .attr('transform', 'translate(0,' + (availableHeight + 20 + margin.bottom + focus.margin().top) + ')')
                    .call(focus);
